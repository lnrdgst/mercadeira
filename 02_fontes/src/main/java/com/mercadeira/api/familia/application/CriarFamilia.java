...
public class CriarFamilia {
    ...
    public Familia criar(UUID usuarioId, String nome) {
        ...
        solicitacaoRepository.findBySolicitanteUsuario_IdAndStatus(usuarioId, StatusSolicitacaoEntradaFamilia.PENDENTE)
                .forEach(solicitacao -> solicitacao.cancelarAutomaticamente());
        return familia;
    }
}
