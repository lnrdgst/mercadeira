...
public interface SolicitacaoPresencaCompraRepository extends JpaRepository<SolicitacaoPresencaCompra, UUID> {
    ...
    Optional<SolicitacaoPresencaCompra> findByCompraIdAndSolicitanteIdAndCicloOperacionalAndEstado(UUID compraId, UUID solicitanteId, long cicloOperacional, EstadoSolicitacaoPresenca estado);
