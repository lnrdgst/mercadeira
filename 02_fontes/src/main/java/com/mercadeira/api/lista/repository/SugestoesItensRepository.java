...
public class SugestoesItensRepository {
    ...
    public List<Sugestao> buscar(UUID familiaId, String termo) {
        return jdbc.query("""
            with usos as (
                ...
                where l.familia_id = :familia and l.status = 'EM_PREPARACAO' and i.removido_em is null
                union all
                ...
                where l.familia_id = :familia and l.status in ('EM_COMPRA', 'FINALIZADA')
            ...
            """, Map.of("familia", familiaId, "termo", termo),
