...
Este documento, o diagrama Mermaid e o DBML em `docs/modelo-v2` formam a fonte de verdade do modelo v2. O estado descrito inclui integralmente a V1 e os complementos da migration V2.
